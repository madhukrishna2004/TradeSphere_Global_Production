"""
HS CODE CHATBOT — Interactive HS Code Classification Assistant

Usage:
  python hs_chat.py --model /path/to/hs_model.pkl
...
logger = logging.getLogger("HSChatbot")
...
def interactive_chat(bundle, log_path: Optional[str] = None) -> None:
